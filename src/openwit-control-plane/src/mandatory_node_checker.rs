...
// REMOVED: MandatoryNodeChecker entirely depends on gossip/network which was removed
// This functionality is deprecated until a non-gossip alternative is implemented

// The entire MandatoryNodeChecker implementation has been commented out because it
// relies on openwit_network::ClusterHandle for gossip-based node discovery.
// A non-gossip alternative (e.g., gRPC-based registration) would need to be implemented
